...
<body>
    <div class=" container Login h-100 ">
        <div class="row Login__1st-Row d-flex align-items-center w-100 h-100">
            <form method="POST"  action="./handlingLogin.php" class="Login__1st-Row__Form d-flex flex-column align-items-center m-auto">
                ...
                <input class=" form-control Login__1st-Row__Form__Input-mail" type="Email" name="email" placeholder="Email address">
                <input class="form-control Login__1st-Row__Form__Input-pass" type="password" name="password" placeholder="Password">
